...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo base_url()?>assets\frontend\logo\KabJayapura.png" type="image/png" sizes="32x32">
    <!-- Bootstrap -->
    ...
    <script src="https://use.fontawesome.com/2862c2111f.js"></script>
    ...
    <div class="wrapper animsition" data-animsition-in-class="fade-in" data-animsition-in-duration="1000" data-animsition-out-class="fade-out" data-animsition-out-duration="1000">
        <div class="container">
             <nav class="navbar navbar-expand-lg navbar-light navbar-default navbar-fixed-top" role="navigation">
                <div class="container">
                    <a class="navbar-brand page-scroll" href="<?php echo base_url()?>"><img src="<?php echo base_url()?>assets\frontend\logo\KabJayapura.png" width="25px" alt="jayapuradev Logo"></a>
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav my-2 my-lg-0">
                          <li class="nav-link page-scroll">
                            <a href="#" ><button class="ui green button"><i class="fa fa-bookmark"></i> Buku Kerja</button></a>
                          </li>
                          <li class="nav-link page-scroll">
            ...
            <div class="footer">
                <div class="container">
                    <div class="col-md-12 text-center">
                        <img src="<?php echo base_url()?>assets\frontend\logo\KabJayapura.png" width="5%" alt="jayapuradev Logo">
                        ...
                        <div class="footer-text">
                            <p>
                                Copyright © 2020 Dispendik Kab. Jayapura.
                            </p>
                        </div>
                    </div>
                </div>
